...
static void mdlInitializeConditions (double *x0, SimStruct *S)
{
    ...
    ufp2 = fopen("debugBBK.txt","w");
    fprintf (ufp2,"udpClient_Initialize finished \n");   // Chunan
    fprintf(ufp2,"ofp pointer: %p \n",ofp);   // ofp is valid pointer here.
    fclose(ufp2);
...
//     ufp2 = fopen("debugBBK.txt","a");
//     fprintf (ufp2,"static void mdlInitializeConditions finished 2 \n");   // Chunan
//     fclose(ufp2);
}
...
static void mdlDerivatives (double *dx, double *x, double *u, SimStruct *S, int tid)
{
    ...
    ufp2 = fopen("debugBBK.txt","a");
    fprintf (ufp2,"static void mdlDerivatives finished 3 \n");   // Chunan
    fprintf(ufp2,"ofp pointer: %p \n",ofp);   // ofp is [type whether it is valid or not]
    fclose(ufp2);
}
...
static void mdlOutputs (double *y, double *x, double *u, SimStruct *S, int tid)
{
    ...
    ufp2 = fopen("debugBBK.txt","a");
    fprintf (ufp2,"static void mdlOutputs starts 4 \n");   // Chunan
    fprintf(ufp2,"ofp pointer: %p \n",ofp);   // ofp is NULL pointer here.
    fclose(ufp2);
    
    ufp3 = fopen("DebugBBK_2.txt","a");
    fprintf(ufp3,"mdlOutputs starts 4 \n");
    fprintf(ufp3,"ofp pointer: %p \n",ofp);
    fclose(ufp3);
...
//     ufp2 = fopen("debugBBK.txt","a");
//     fprintf (ufp2,"static void mdlOutputs middle 4.25 \n");   // Chunan
//     fclose(ufp2);
    /* output equations */
    ...
    ufp2 = fopen("debugBBK.txt","a");
    fprintf (ufp2,"static void mdlOutputs starts 4.5 \n");   // Chunan
    fprintf(ufp2,"ofp pointer: %p \n",ofp);   // ofp is NULL pointer here.
    fclose(ufp2);
...
//      ufp2 = fopen("debugBBK.txt","a");
//     fprintf (ufp2,"udpClient_CommunicateThroughUDP finished 5 \n");   // Chunan
//     fclose(ufp2);
...
//     ufp2 = fopen("debugBBK.txt","a");
//     fprintf (ufp2,"static void mdlOutputs finishes 6 \n");   // Chunan
//     fclose(ufp2);
}
