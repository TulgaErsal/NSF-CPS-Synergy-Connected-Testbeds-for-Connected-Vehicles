...
const XXInteger xx_number_of_outputs = 4;
...
XXDouble xx_V[9];		/* variables */
XXMatrix xx_M[2];		/* matrices */
XXDouble xx_U[4];		/* unnamed */
...
static void mdlOutputs (double *y, double *x, double *u, SimStruct *S, int tid)
{
	...
	udpClient_CommunicateThroughUDP (xx_M[0].mat, 3, xx_M[1].mat, 4, xx_major);
	/* [engine.e, actualTime, dropRate, rtt] = dll (dll_name, function_name, in); */
	xx_V[1] = xx_M[1].mat[0];
	xx_V[5] = xx_M[1].mat[1];
	xx_V[3] = xx_M[1].mat[2];
