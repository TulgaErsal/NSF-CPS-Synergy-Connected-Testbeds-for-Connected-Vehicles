...
const XXInteger xx_number_of_inputs = 41;//modify server 1*1+1*(NP=40)
const XXInteger xx_number_of_outputs = 50;//modify here 6*1+1*(NP=40)+4
...
XXDouble xx_V[93];		/* variables *///modify here //modify server xx_number_of_outputs+xx_number_of_inputs+2
XXMatrix xx_M[2];		/* matrices */
XXDouble xx_U[50];		/* unnamed */ //modify here xx_number_of_outputs
...
static void mdlInitializeConditions (double *x0, SimStruct *S)
{
	...
	xx_M[0].mat = &xx_V[51];		/* in */ //modify here xx_number_of_outputs+1
	xx_M[0].rows = 1;
	xx_M[0].columns = 42;  //modify server xx_number_of_inputs+1
	xx_M[1].mat = &xx_U[0];		/* xx_U1 */
	xx_M[1].rows = 1;
	xx_M[1].columns = 50;  //modify here xx_number_of_outputs
...
static void mdlOutputs (double *y, double *x, double *u, SimStruct *S, int tid)
{
	...
	udpServer_CommunicateThroughUDP (xx_M[0].mat, 42, xx_M[1].mat, 50, xx_major);
